...
const Login = () => {
    ...
    return (
        <div className="w-dvw h-dvh flex flex-col justify-center items-center bg-gradient-to-r from-blue-500/50 to-purple-500/50">
            ...
            <form
                method="POST"
                className="w-[35vw] h-fit p-4 bg-white rounded text-black shadow-md grid grid-cols-2 gap-4"
            ...
            >
                ...
                <button
                    type="submit"
                    className="bg-blue-500 text-white p-2 rounded cursor-pointer hover:bg-blue-600 active:bg-blue-950"
                >
                    Submit
                </button>
            </form>
